...
## smv error:
## Fold2: preprocessor 1/1, model 27/36 (predictions): Error: $ operator is invalid for atomic vectors
## also I waited for hours but it won't finish!
...
# output latex table
all_ans[,c('alg','.estimate','std_err','penalty','cost_complexity','tree_depth',
           'min_n','hidden_units','neighbors','cost','rbf_sigma')] %>% knitr::kable(format = 'latex')
